...
<<<<<<< HEAD
  - Finish Lab 1 by `r advdate(dayone, 4, assignment="f")`
=======
  - Finish Lab 1 by `r advdate(dayone, 2, assignment="f")`
>>>>>>> bff4cdfb118ce57e52854c4d39bdc9fb44a0f0d5
- [ ] `r advdate(dayone, 2, topic)`
  - Finish Lab 2 by `r advdate(dayone, 4, assignment="f")`
- [ ]  `r advdate(dayone, 3, topic)`
  - Finish Lab 3  by `r advdate(dayone, 5, assignment="f")`
  - Finish portfolio piece 1 by `r advdate(dayone, 6, assignment="f")`
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by `r advdate(dayone, 5, assignment="f")`
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 5  by `r advdate(dayone, 6, assignment="f")`
...
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 8 by `r advdate(dayone, 10, assignment="f")`
  - Finish Unessay 1 due on `r advdate(dayone, 11, assignment="f")`
- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 9 by `r advdate(dayone, 11, assignment="f")`
  - Finish  portfolio piece 4 by `r advdate(dayone, 11, assignment="f")`
...
- [ ] `r advdate(dayone, 11, topic)`
  ...
  - Finish portfolio piece 5 by `r advdate(dayone, 12, assignment="f")`
- [ ] `r advdate(dayone, 12, topic)`
  - Finish Lab 12 by `r advdate(dayone, 12, assignment="f")`
  - Finish portfolio piece 6 by `r advdate(dayone, 13, assignment="f")`
